  ...
  return (
    ...
    >
      ...
      <div className="bg-black w-2/5 rounded overflow-auto transition-all ">
        <div>
          <p className="text-center mt-3">Related document Suggestion</p>
          <ul className="bg-slate-500 border-red-400 border-2  p-1 m-3 rounded-lg leading-3 text-xs ">
        ...
        <div>
          <p className="text-center mt-3">Interact with the Advisor</p>
          <div className="bg-slate-500 border-red-400 border-2  p-1 m-3 rounded-lg leading-3 text-xs overflow-y-auto h-40">
